...
const BLOG = {
  AUTHOR: 'wavewang', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://wavewang.vercel.app', // 网站地址
  KEYWORDS: 'Notion, 博客, OpenStack, 虚拟化, python, 网络, Linux, 内核', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'a4b3e3fd516a463981595f30ab31aaf4', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'wangleiwave@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/GreenHandTo',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'GreenHandTo/notionnext_discuss', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOHge8UQ', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOHge8Uc4CPsE_', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
